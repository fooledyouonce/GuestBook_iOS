//
//  GBFeedPostHeaderTableViewCell.swift
//  GuestBook
//
...
protocol GBFeedPostHeaderTableViewCellDelegate: AnyObject {
    func didTapMoreButton()
}

class GBFeedPostHeaderTableViewCell: UITableViewCell {

    weak var delegate: GBFeedPostHeaderTableViewCellDelegate?

    static let identifier = "GBFeedPostHeaderTableViewCell"
    ...
    private let profilePhotoImageView: UIImageView = {
        ...
        imageView.backgroundColor = UIColor(named: "guestBookBG")
        return imageView
    }()
